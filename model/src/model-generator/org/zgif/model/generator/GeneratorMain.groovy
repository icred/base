...
import org.zgif.model.generator.javacode.Modifier
import org.zgif.model.generator.javacode.Property
import org.zgif.model.generator.javacode.writer.BasicClassWriter
import org.zgif.model.generator.javacode.writer.EnumClassWriter
...
public class GeneratorMain {
    ...
    private static Property elementToProperty(String elementLine) {
        ...
        if(typeString.startsWith('eTYPE')) {
            prop.type = new BasicClass(packageName:'org.zgif.model.datatype.enumeration', name:typeString[6..-1])
            ...
            if(simpleName.equals("ExtensionMap")) {
                ...
                prop.type = new BasicClass(packageName:'org.zgif.model.datatype', name:simpleName)
            } else if(['Address', 'EnergyRating'].contains(simpleName)) {
                prop.type = new BasicClass(packageName:'org.zgif.model.node.group', name:simpleName)
            }
    ...
    public static void main(String[] args) {
        ...
        File srcDir = new File(/.\src\main\generated-sources/)
        ...
        xsdDir.eachFileMatch({ it.startsWith('entity_') }) { File entityXsdFile ->
            ...
            entityXsdFile.eachLine { String line, int lineNumber ->
                if(line.contains('<xs:complexType name="TYPE_') && !line.contains("ListOf")) {
                    ...
                    entity.packageName = 'org.zgif.model.node.entity'
                    entity.superClass = new BasicClass(packageName:'org.zgif.model.node.entity', name:'AbstractEntityNode')
                    entity.annotations.add new Annotation(packageName:'org.zgif.model.annotation', name:'Node')
                }
                        ...
                        if(line.contains('xs:element') || line.contains('xs:attribute')) {
                            ...
                            if(prop != null) {
                                if(prop.type.name.startsWith('Map<')) {
                                    prop.annotations.add new Annotation(packageName:'org.zgif.model.annotation', name:'ChildList');
                                } else if(prop.type.packageName.equals('org.zgif.model.node.group')) {
                                    prop.annotations.add new Annotation(packageName:'org.zgif.model.annotation', name:'GroupNode');
                                } else if(line.contains('xs:element')) {
                                    prop.annotations.add new Annotation(packageName:'org.zgif.model.annotation', name:'DataField');
                                } else {
                                    prop.annotations.add new Annotation(packageName:'org.zgif.model.annotation', name:'Attribute');
                                }
        ...
        new File(xsdDir, 'types_sub.xsd').eachLine { String line, int lineNumber ->
            if(line.contains("<xs:complexType")) {
                ...
                if(['Amount', 'Area'].contains(simpleName)) {
                    ...
                    curSub = new BasicClass(packageName:'org.zgif.model.node.group', name:simpleName)
                    curSub.superClass = new JavaClass('org.zgif.model.node.group', 'AbstractGroupNode')
                }
            }
        ...
        new File(xsdDir, 'types_enumeration.xsd').eachLine { String line ->
            if(line.contains("<xs:simpleType")) {
                ...
                curEnum = new EnumClass(packageName:'org.zgif.model.datatype.enumeration', name: simpleName)
            }
            ...
            if(curEnum != null) {
                ...
                if(line.contains('<xs:pattern')) {
                    ...
                    BasicClass patternEnum = new BasicClass(packageName:'org.zgif.model.datatype.enumeration', name: curEnum.name)
